<?php /* Smarty version 2.6.32, created on 2021-11-26 10:10:02
         compiled from train6-back-sales-login.html */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>業務後台管理登入頁面</title>
</head>
<body>
    <div class="container">
        <h2>業務後台管理登入頁面</h2>
        <form action="train6-back-sales-login.php" method="post">
